...
s3_client = boto3.client('s3', 
                      aws_access_key_id='AKIARDDQ4UFO2S57IDL7', 
                      aws_secret_access_key='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', 
                      region_name='us-east-1'
                      )
s3_client.download_file('resnetmodelecc', 'resnet_model.h5', 'resnet_model.h5')
